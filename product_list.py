...
def get_pages_count(html):
    ...
    pagination = soup.find_all('div', class_='ui-pagination__page')
    if pagination:
...
if __name__ == "__main__":
    url = 'https://sbermarket.ru/api/stores/1/products?tid=ovoshchi-frukty-oriekhi/ovoshchi&page=2&per_page=20&sort=popularity'
    products = get_products(url)
    print(products)

#https://sbermarket.ru/api/stores/10/products?tid=ovoshchi-frukty-oriekhi/frukty&page=2&per_page=20&sort=popularity
